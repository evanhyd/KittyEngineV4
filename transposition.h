...
public:
	...
	Transposition();
	Transposition(U64 new_position_key, int new_depth_searched_beyond, int new_score, int new_flag);
	...
	static int ProbeHashScore(const Transposition* tt, size_t tt_size, U64 position_key, int depth_searched_beyond, int alpha, int beta, int side_to_move);
